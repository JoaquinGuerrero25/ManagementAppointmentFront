...
export const AppointmentStatusCard = ({ appointmentConfirmed, appointmentCancel }) => {
    const data = [
        { name: 'Citas confirmadas', value: appointmentConfirmed },
        { name: 'Citas canceladas', value: appointmentCancel },
    ];
    ...
    return (
        ...
        >
            ...
            <Typography variant="body2" width='100%' fontWeight='400' fontSize='0.875rem' color="text.secondary" margin='4px 0px 0px' textAlign='start'>
                Comparativa entre citas confirmadas y canceladas
            </Typography>
            ...
            <Stack direction="row" justifyContent="center" spacing={3} mt={2}>
                <LegendItem color={COLORS[0]} label="Confirmadas" />
                <LegendItem color={COLORS[1]} label="Canceladas" />
            </Stack>
        </Card>
    );
};
